    ...
    def forward(self, data_src, data_tgt=0, label_src=0, mark=1):
        ...
        if self.training == True:
            if mark == 1:
                ...
                joint_loss += loss.mmd(data_src, data_tgt_son1)
                joint_loss += loss.coral(data_src, data_tgt_son1)
                ...
                return cls_loss, joint_loss, l1_loss
            ...
            if mark == 2:
                ...
                data_src = self.avgpool(data_src)
                data_src = data_src.view(data_src.size(0), -1)
                joint_loss += loss.mmd(data_src, data_tgt_son2)
                joint_loss += loss.coral(data_src, data_tgt_son2)
